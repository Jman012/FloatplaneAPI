...
validate-trimmed: trim
	npx openapi-generator-cli validate -i floatplane-openapi-specification-trimmed.json
docs-skeleton:
	mkdir -p Docs
	cp ./static/index.html ./Docs/index.html
yaml: validate validate-trimmed docs-skeleton
	npx json2yaml floatplane-openapi-specification.json > Docs/floatplane-openapi-specification.yaml
	npx json2yaml floatplane-openapi-specification-trimmed.json > Docs/floatplane-openapi-specification-trimmed.yaml
...
docs-oag-html2: docs-skeleton
	npx openapi-generator-cli generate -i floatplane-openapi-specification-trimmed.json -o Docs/OAG-html2/ -g html2
docs-oag-dynamic-html: docs-skeleton
	npx openapi-generator-cli generate -i floatplane-openapi-specification-trimmed.json -o Docs/OAG-dynamic-html/ -g dynamic-html
docs-redoc: docs-skeleton
	mkdir -p Docs/Redoc
	npx redoc-cli bundle -o Docs/Redoc/redoc-static.html floatplane-openapi-specification-trimmed.json
docs-rapidoc: docs-skeleton
	mkdir -p Docs/Rapidoc
	cp ./static/rapidoc.html ./Docs/Rapidoc/rapidoc.html
docs-reslate: docs-skeleton
	mkdir -p Docs/ReSlateDocs
	cd Docs/ReSlateDocs; npx reslate init Docs/ReSlateDocs
	npx widdershins floatplane-openapi-specification-trimmed.json -o Docs/ReSlateDocs/index.md
	cd Docs/ReSlateDocs; npx reslate build
	rm -rf Docs/ReSlateDocs/site
	mv Docs/ReSlateDocs/_site Docs/ReSlateDocs/site
docs-postman: docs-skeleton
	mkdir -p Docs/Postman-v2.1
	npx openapi2postmanv2 --spec floatplane-openapi-specification-trimmed.json --output Docs/Postman-v2.1/floatplaneapi-postman2.1-collection.json --pretty -O folderStrategy=Tags,includeAuthInfoInExample=false
docs-swaggerui: docs-skeleton
...
docs-trimmed: validate-trimmed docs-oag-html2 docs-oag-dynamic-html docs-redoc docs-rapidoc docs-reslate docs-postman docs-swaggerui
	@echo "docs-trimmed complete!"

# Section: Full docs

docs-oag-html2-full: docs-skeleton
	npx openapi-generator-cli generate -i floatplane-openapi-specification.json -o Docs/OAG-html2-full/ -g html2
docs-oag-dynamic-html-full:
	npx openapi-generator-cli generate -i floatplane-openapi-specification.json -o Docs/OAG-dynamic-html-full/ -g dynamic-html
docs-redoc-full: docs-skeleton
	mkdir -p Docs/Redoc-full
	npx redoc-cli bundle -o Docs/Redoc-full/redoc-static.html floatplane-openapi-specification.json
...
docs-reslate-full: docs-skeleton
	...
	npx widdershins floatplane-openapi-specification.json -o Docs/ReSlateDocs-full/index.md
...
docs-postman-full: docs-skeleton
	...
	npx openapi2postmanv2 --spec floatplane-openapi-specification.json --output Docs/Postman-v2.1-full/floatplaneapi-postman2.1-collection.json --pretty -O folderStrategy=Tags,includeAuthInfoInExample=false
...
docs-async-frontend: docs-skeleton
	npx ag -o Docs/AsyncAPIFrontend floatplane-asyncapi-frontend-specification.json @asyncapi/html-template
docs-async-chat:
	npx ag -o Docs/AsyncAPIChat floatplane-asyncapi-chat-specification.json @asyncapi/html-template
...
docs-static: trim docs-skeleton
	cp ./floatplane-openapi-specification.json ./floatplane-openapi-specification-trimmed.json Docs/
	cp ./floatplane-asyncapi-frontend-specification.json Docs/
	cp ./floatplane-asyncapi-chat-specification.json Docs/
