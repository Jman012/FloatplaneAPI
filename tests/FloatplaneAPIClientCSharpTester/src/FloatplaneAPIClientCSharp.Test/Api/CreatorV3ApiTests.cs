...
namespace FloatplaneAPIClientCSharp.Test.Api
{
    ...
    public class CreatorV3ApiTests : IDisposable
    {
        ...
        public void GetCreatorTest()
        {
            ...
            //string id = null;
            //var response = instance.GetCreator(id);
            //Assert.IsType<CreatorModelV3>(response);
        }
        ...
        public void GetCreatorsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string search = null;
            //var response = instance.GetCreators(search);
            //Assert.IsType<List<CreatorModelV3>>(response);
        }
    }
}
