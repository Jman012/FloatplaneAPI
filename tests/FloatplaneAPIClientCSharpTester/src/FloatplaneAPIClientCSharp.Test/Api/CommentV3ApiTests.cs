...
namespace FloatplaneAPIClientCSharp.Test.Api
{
    ...
    public class CommentV3ApiTests : IDisposable
    {
        ...
        public void GetCommentRepliesTest()
        {
            ...
            //int limit = null;
            //string rid = null;
            //var response = instance.GetCommentReplies(comment, blogPost, limit, rid);
            //Assert.IsType<List<CommentReplyModel>>(response);
        }
        ...
        public void GetCommentsTest()
        {
            ...
            //var response = instance.GetComments(blogPost, limit, fetchAfter);
            //Assert.IsType<List<CommentModel>>(response);
        }
