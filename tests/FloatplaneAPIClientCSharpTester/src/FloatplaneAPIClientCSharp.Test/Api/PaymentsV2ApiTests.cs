...
namespace FloatplaneAPIClientCSharp.Test.Api
{
    ...
    public class PaymentsV2ApiTests : IDisposable
    {
        ...
        public void ListAddressesTest()
        {
            ...
            //var response = instance.ListAddresses();
            //Assert.IsType<List<PaymentAddressModel>>(response);
        }
        ...
        public void ListInvoicesTest()
        {
            ...
            //Assert.IsType<PaymentInvoiceListV2Response>(response);
        }
        ...
        public void ListPaymentMethodsTest()
        {
            ...
            //Assert.IsType<List<PaymentMethodModel>>(response);
        }
    }
}
