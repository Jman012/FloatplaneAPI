...
namespace FloatplaneAPIClientCSharp.Test.Api
{
    ...
    public class AuthV3ApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test an instance of AuthV3Api
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' AuthV3Api
            //Assert.IsType<AuthV3Api>(instance);
        }
        ...
        public void GetCaptchaInfoTest()
        {
            ...
            //var response = instance.GetCaptchaInfo();
            //Assert.IsType<GetCaptchaInfoResponse>(response);
        }
    }
}
