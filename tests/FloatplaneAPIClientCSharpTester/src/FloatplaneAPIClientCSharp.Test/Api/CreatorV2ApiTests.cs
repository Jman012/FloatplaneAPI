...
namespace FloatplaneAPIClientCSharp.Test.Api
{
    ...
    public class CreatorV2ApiTests : IDisposable
    {
        ...
        public void GetCreatorInfoByNameTest()
        {
            ...
            //List<string> creatorURL = null;
            //var response = instance.GetCreatorInfoByName(creatorURL);
            //Assert.IsType<List<CreatorModelV2>>(response);
        }
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //List<string> creatorGUID = null;
            //var response = instance.GetInfo(creatorGUID);
            //Assert.IsType<List<CreatorModelV2>>(response);
        }
    }
}
