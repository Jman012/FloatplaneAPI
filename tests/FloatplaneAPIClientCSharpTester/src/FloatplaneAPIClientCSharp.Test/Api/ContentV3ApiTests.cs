...
namespace FloatplaneAPIClientCSharp.Test.Api
{
    ...
    public class ContentV3ApiTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //List<string> creatorIds = null;
            //var response = instance.GetContentTags(creatorIds);
        ...
        public void GetCreatorBlogPostsTest()
        {
            ...
            //var response = instance.GetCreatorBlogPosts(id, limit, fetchAfter, search, tags, hasVideo, hasAudio, hasPicture, hasText, sort, fromDuration, toDuration, fromDate, toDate);
        ...
        public void GetMultiCreatorBlogPostsTest()
        {
            ...
            //var response = instance.GetMultiCreatorBlogPosts(ids, limit, fetchAfter);
            //Assert.IsType<ContentCreatorListV3Response>(response);
        }
