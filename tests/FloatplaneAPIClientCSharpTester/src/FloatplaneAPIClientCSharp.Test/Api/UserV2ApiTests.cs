...
namespace FloatplaneAPIClientCSharp.Test.Api
{
    ...
    public class UserV2ApiTests : IDisposable
    {
        ...
        public void GetSecurityTest()
        {
            ...
            //var response = instance.GetSecurity();
            //Assert.IsType<UserSecurityV2Response>(response);
        }
        ...
        public void GetUserInfoTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //List<string> id = null;
            //var response = instance.GetUserInfo(id);
            //Assert.IsType<UserInfoV2Response>(response);
        }
        ...
        public void GetUserInfoByNameTest()
        {
            ...
            //var response = instance.GetUserInfoByName(username);
            //Assert.IsType<UserNamedV2Response>(response);
        }
        ...
        public void UserCreatorBanStatusTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string creator = null;
            //var response = instance.UserCreatorBanStatus(creator);
